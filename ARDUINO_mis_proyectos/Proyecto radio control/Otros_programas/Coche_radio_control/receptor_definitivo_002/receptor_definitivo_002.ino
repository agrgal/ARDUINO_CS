...
uint8_t buflen = VW_MAX_MESSAGE_LEN;
  ...
  digitalWrite(pinTester,HIGH); // parpadea la luz en recepcin
  ...
  valorAceleracion = valorAceleracion + 1000;
  valorVolanteNuevo = valorVolanteNuevo + 5000;
  
  Serial.print(valorAceleracion); // sumando 1000
  Serial.print(",");
  Serial.print(valorVolanteNuevo);  // sumando 5000
  Serial.print(",");
  Serial.print(marchaAD); // sin sumar
  Serial.println(); 
  ...
  delay(5); // retraso en la recepcion del mensaje
    ...
    digitalWrite(pinTester,LOW); // parpadea la luz en recepcin
  }
}
