...
const int valorVolanteMedio = (valorVolanteMIN+valorVolanteMAX) / 2; // valor intermedio
const int valorAmplitudEnGrados = 30; // grados a izquierda y derecha.
...
uint8_t buflen = VW_MAX_MESSAGE_LEN;
  ...
  if ((valorVolanteNuevo > 1.05*valorVolanteAntiguo) || (valorVolanteNuevo < 0.95*valorVolanteAntiguo)) { // Si em muevo en una horquilla de 5%
