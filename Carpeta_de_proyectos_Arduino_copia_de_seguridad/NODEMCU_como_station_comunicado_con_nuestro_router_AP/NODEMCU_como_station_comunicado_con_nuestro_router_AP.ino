...
const char* ssid = "JAZZTEL_shny";        //Indicamos el nombre de la red WiFi (SSID) a la que queremos conectarnos.
const char* password = "3z7s5tvbtu4s";    //Indicamos la contraseña de de red WiFi
